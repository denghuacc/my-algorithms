...
class MyCircularDeque {
  ...
  constructor(k: number) {
    this.capacity = k + 1;
    this.items = new Array(k + 1).fill(0);
    this.frontPointer = 0;
    this.rearPointer = 0;
  }
  ...
  insertFront(value: number): boolean {
    ...
    this.frontPointer = (this.frontPointer - 1 + this.capacity) % this.capacity;
    this.items[this.frontPointer] = value;
    return true;
  }
  ...
  insertLast(value: number): boolean {
    ...
    this.items[this.rearPointer] = value;
  ...
  deleteLast(): boolean {
    ...
    this.rearPointer = (this.rearPointer - 1 + this.capacity) % this.capacity;
    return true;
  }
  ...
  getRear(): number {
    ...
    return this.items[(this.rearPointer - 1 + this.capacity) % this.capacity];
  }
  ...
  isFull(): boolean {
    return (this.rearPointer + 1) % this.capacity === this.frontPointer;
  }
}
