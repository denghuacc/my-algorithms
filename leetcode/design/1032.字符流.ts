...
class StreamChecker {
  ...
  query(letter: string): boolean {
    this.tmp = this.tmp.getChild(letter.charCodeAt(0) - "a".charCodeAt(0));
    return this.tmp.getIsEnd();
  }
}
...
class TrieNode {
  ...
  setChild(index: number, node: TrieNode) {
