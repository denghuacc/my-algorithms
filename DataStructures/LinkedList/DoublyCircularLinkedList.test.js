const DCLL = require('./DoublyCircularLinkedList')

// 实例化
const cities = new DCLL()
...
// 删除元素
console.log(cities.indexOf('Shenzhen')) // 3
...
// Node {
// element: 'Beijing',
// next: Node { element: 'Shanghai', next: null, prev: [Circular] },
// prev: null
// }
