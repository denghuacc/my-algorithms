...
describe("HashTableLinearProbing", () => {
  ...
  test("generates hashCode", () => {
    // numbers
    const numberHashTable = new HashTableLinearProbing<number, number>();
    ...
    // strings
    const stringHashTable = new HashTableLinearProbing<string, number>();
    ...
    // objects
    const objHashTable = new HashTableLinearProbing<MyObj, MyObj>();
    const myObjList = [];
    for (let i = 1; i <= 5; i++) {
