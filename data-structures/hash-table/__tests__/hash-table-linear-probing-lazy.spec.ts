...
describe("HashTableLinearProbingLazy", () => {
  ...
  test("generates hashCode", () => {
    // numbers
    const numberHashTable = new HashTableLinearProbingLazy<number, number>();
    ...
    // strings
    const stringHashTable = new HashTableLinearProbingLazy<string, number>();
    ...
    // objects
    const objHashTable = new HashTableLinearProbingLazy<MyObj, MyObj>();
    const myObjList = [];
    for (let i = 1; i <= 5; i++) {
