...
describe("PriorityQueue", () => {
  ...
  test("enqueue", () => {
    ...
    expect(priorityQueue.toString()).toBe("PriorityQueue: front [ 1 ]");
    priorityQueue.enqueue(5);
    expect(priorityQueue.size).toBe(2);
    expect(priorityQueue.isEmpty()).toBe(false);
    expect(priorityQueue.toString()).toBe("PriorityQueue: front [ 5, 1 ]");
    priorityQueue.enqueue(3);
    expect(priorityQueue.size).toBe(3);
    expect(priorityQueue.isEmpty()).toBe(false);
    expect(priorityQueue.toString()).toBe("PriorityQueue: front [ 5, 1, 3 ]");
  });
  ...
  test("dequeue", () => {
    ...
    expect(priorityQueue.size).toBe(2);
    expect(priorityQueue.isEmpty()).toBe(false);
    expect(priorityQueue.toString()).toBe("PriorityQueue: front [ 3, 1 ]");
